...
//
//     final statusSingle = statusSingleFromJson(jsonString);
...
String statusSingleToJson(StatusSingle data) => json.encode(data.toJson());

class StatusSingle {
  StatusSingleStatus? status;
  ...
  factory StatusSingle.fromJson(Map<String, dynamic> json) => StatusSingle(
        status: json["status"] == null
            ? null
            : StatusSingleStatus.fromJson(json["status"]),
      );
...
class StatusSingleStatus extends MailModel {
  ...
  factory StatusSingleStatus.fromJson(Map<String, dynamic> json) =>
      StatusSingleStatus(
        id: json["id"],
        name: json["name"],
        color: json["color"],
